const mangayomiSources = [{
    ...
    "iconUrl": "https://raw.githubusercontent.com/IlNinjaDiBattipaglia/mangayomi-extensions/main/javascript/icon/en.allanime.png",
    "typeSource": "single",
    "itemType": 1,
    "isNsfw": false,
    "version": "0.0.5",
    ...
    async getVideoList(url) {
        ...
        for (const video of videoJson.data.episode.sourceUrls) {
            ...
            try {
                ...
                // console.log(`ERROR BROOO ${videoUrl}: ${e}`);
            }
        }
